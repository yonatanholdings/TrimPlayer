 ...
 *
 * <p>PlaybackService listens so the running episode's in-memory segment snapshot
 ...
 *
 * <p>Carries the episode GUID so the service can ignore edits for an episode other
